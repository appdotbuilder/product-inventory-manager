...
export default function Inventory({ products, categories, statistics, filters }: Props) {
            ...
            <div className="container mx-auto px-4 py-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-yellow-600">{statistics.lowStockCount}</div>
                            <p className="text-xs text-muted-foreground">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-red-600">{statistics.outOfStockCount}</div>
                            <p className="text-xs text-muted-foreground">
